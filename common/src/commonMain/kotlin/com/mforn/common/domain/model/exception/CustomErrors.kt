...
private const val BLUETOOTH_ERROR = 1003
private const val INTERNAL_ERROR = 1004
...
sealed class CustomErrorType {
    ...
    class BluetoothError(sdkMessage: String = "") : CustomException("Bluetooth error: $sdkMessage", BLUETOOTH_ERROR)
